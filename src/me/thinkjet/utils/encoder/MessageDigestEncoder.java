 ...
 * {@link BaseDigestEncoder#setEncodeHashAsBase64(boolean)}
 * <p>
 * This {@code PasswordEncoder} can be used directly as in the following
 * example:
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * If desired, the {@link #setIterations iterations} property can be set to
 * enable "<a href="http://en.wikipedia.org/wiki/Key_strengthening
 * ">password stretching</a>" for the digest calculation.
 * 
 * @author Ray Krueger
 * @author Luke Taylor
 * @since 1.0.1
 */
public class MessageDigestEncoder extends BaseDigestEncoder {
	 ...
	 */
	public String encode(String rawStr, Object salt) {
		String saltedPass = mergePasswordAndSalt(rawStr, salt, false);
	 ...
	 */
	public boolean isValid(String encStr, String rawStr, Object salt) {
		String pass1 = "" + encStr;
		String pass2 = encode(rawStr, salt);

		return EncoderUtils.equals(pass1, pass2);
	}
